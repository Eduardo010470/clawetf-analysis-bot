...
def analisar_com_claude(relatorio, dados):
    ...
    prompt = "Voce e um assistente financeiro analisando carteira de cripto ETFs de Eduardo, medico brasileiro, DCA longo prazo via Avenue/Nomad." + spot_str + "\n\nRELATORIO:\n" + relatorio + "\n\nDADOS:\n" + contexto + "\n\nIMPORTANTE: os precos acima sao precos da COTA de cada ETF na NASDAQ, nao a cotacao do ativo subjacente. O preco de uma cota de FBTC ou IBIT nao e o preco do Bitcoin, e o de ETHA ou FETH nao e o preco do Ethereum. Nunca apresente esses numeros como cotacao de BTC ou ETH nem estime a cotacao do ativo a partir deles.\n\nAnalise CONCISA max 300 palavras: 1) Situacao geral 2) Destaques do dia 3) Sugestao rebalanceamento 4) Sugestao aporte se houver capital 5) Perspectiva mercado (ao falar de BTC e ETH, cite as cotacoes spot informadas no inicio deste prompt). Seja direto e honesto sem otimismo excessivo."
    try:
